 ...
 *
 * @discussion This index path returned by this method must not be used when querying
 *    the @c ASCollectionView. To convert the index path, call
 ...
 * @warning This method is substantially more expensive than UICollectionView's version.
 *
 * This method is deprecated in 2.0. Use @c reloadDataWithCompletion:nil instead.
 */
